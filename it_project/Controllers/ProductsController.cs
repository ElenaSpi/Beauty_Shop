...
namespace it_project.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Price,Category,Rating,ImageURL")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Price,Category,Rating,ImageURL")] Product product)
        {
            if (ModelState.IsValid)
            {
        ...
        */
        ...
        [HttpPost]
        public ActionResult InsertNewClient(ClientProduct model)
        {
